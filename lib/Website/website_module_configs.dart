...
const leadershipFields = [
  ...
  FieldConfig(key: 'position', label: 'Position', type: FieldType.text, required: true),
  ...
  FieldConfig(key: 'bio', label: 'Biography', type: FieldType.longText),
...
const manifestoFields = [
  ...
  FieldConfig(key: 'title', label: 'Title', type: FieldType.text, required: true),
  FieldConfig(key: 'description', label: 'Description', type: FieldType.longText),
  FieldConfig(key: 'order', label: 'Display Order', type: FieldType.number),
];
...
const newsFields = [
  ...
  FieldConfig(key: 'content', label: 'Content', type: FieldType.longText, required: true),
...
const galleryFields = [
  ...
  FieldConfig(key: 'caption', label: 'Caption', type: FieldType.text),
...
/// them and update the status, never edit the message itself.
